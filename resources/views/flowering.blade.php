...
.addtocart i {
  ...
  transition: all 0.3s;
            ...
            <header>
                ...
                <div class="header-content-title">
                    <div style="background-image:
                        ...
                        data-source-url="../../OPC190_nursery/OPC02/image/catalog/demo/banners/parallax.jpg"
                        class="parallex">
                    </div>
                </div>
    ...
    <div class="container">
        <h1 class="text-center mt-5"><b class="mt-5">Flowering Plants</b></h1>
	    <div class="slider mt-5" >
			<div class="owl-carousel">
				...
				<div class="slider-card">
					...
					<h5 class="mb-0 text-center">Name: <b>{{$p->Name}}</b></h5>
					<h5 class="mb-0 text-center">Price: <b>{{$p->Price}}</b></h5>
